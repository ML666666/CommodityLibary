...
export default class HomePage extends Component{
   ...
   initEditor () {
    ...
    handleInSertHTML(){
      this.editor.txt.html(`<div>测试</div>`);
    }
    render(){
        return(
            <Fragment>
              ...
              <div style={{marginTop:'24px'}}>
                <Button style={{marginRight:'16px'}} onClick={this.handleMakeSure.bind(this)}>确定</Button>
                <Button style={{marginRight:'16px'}} onClick={this.handleInSertHTML.bind(this)}>插入</Button>
              </div>
            </Fragment>
        )
    }
